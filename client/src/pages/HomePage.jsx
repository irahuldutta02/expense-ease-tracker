            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Track your{" "}
                  <span className="font-medium text-blue-500">Expense</span>{" "}
                  with <span className="font-medium text-blue-500">Ease</span>{" "}
                </p>
              ...
              <p className="mt-3 text-gray-600 dark:text-gray-400">
                Subscribe to our newsletter with a No Spam promise
              </p>
            </div>
